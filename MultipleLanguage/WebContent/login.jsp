...
<body>
	<div
		...
		<a href="${pageContext.request.contextPath}/login.do?lang=en">Login
			(English)</a> &nbsp;&nbsp; <a
			href="${pageContext.request.contextPath}/login.do?lang=fr">Login
			(French)</a> &nbsp;&nbsp; <a
			href="${pageContext.request.contextPath}/login.do?lang=vi">Login
			(Vietnamese)</a>
	</div>
